    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div 
          ...
          className="relative group overflow-hidden bg-white p-6 rounded-xl shadow-sm border border-gray-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-md hover:border-green-300 cursor-pointer">
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50 sticky top-0 z-10">
                    <tr>
                      ...
                      <th scope="col" className="px-6 py-3 text-right text-xs font-bold text-gray-500 uppercase tracking-wider">Net Profit</th>
                    </tr>
                  </thead>
                  <tbody className="bg-white divide-y divide-gray-100">
                    {stats.todaySoldItems.map((item: any) => (
                      <tr key={item.id} className="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right">
                          <div className={`text-sm font-black ${item.netProfit > 0 ? 'text-green-600' : item.netProfit < 0 ? 'text-red-500' : 'text-gray-500'}`}>
